    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        MainActivity_.this.buttonClick(view);
                    }
        ...
        {
            View view = hasViews.findViewById(id.btn6);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
        ...
        {
            View view = hasViews.findViewById(id.btn7);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
        ...
        {
            View view = hasViews.findViewById(id.btn8);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
        ...
        {
            View view = hasViews.findViewById(id.btn9);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
